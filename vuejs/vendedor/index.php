        ...
        <div class="ModalWindow-container">
          <header class="ModalWindow-heading">
            <div class="row valign-wrapper">
              <div class="col s10">
                <h4 class="left">Agregar vendedor</h4>
              </div>
              <div class="col s2">
          ...
          <form class="ModalWindow-content row" @submit.prevent="createStudent">
            <div class="input-field col s12">
              ...
              <input name="idvendedor" type="text" placeholder="Cedula vendedor" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">account_circle</i>
      ...
      <section :class="['ModalWindow', displayEditModal]" v-if="showEditModal">
        <div class="ModalWindow-container">
          ...
          <form class="ModalWindow-content row" @submit.prevent="updateStudent">
            <div class="input-field col s12">
              <i class="material-icons prefix">account_circle</i>
              <input name="idnew" type="text" placeholder="Numero de cedula" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">email</i>
              <input v-model="activeStudent.nombre" name="nombre" type="text" placeholder="Nombre vendedor" required>
            </div>
            <div class="input-field col s12">
            ...
            <div class="input-field col s12">
              ...
              <input v-model="activeStudent.idvendedor" name="idvendedor" type="hidden" required>
            </div>
          </form>
        </div>
      </section>
