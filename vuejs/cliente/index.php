        ...
        <div class="ModalWindow-container">
          ...
          <form class="ModalWindow-content row" @submit.prevent="createStudent">
            <div class="input-field col s12">
              ...
              <input name="idcliente" type="text" placeholder="Cedula Cliente" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">account_circle</i>
      ...
      <section :class="['ModalWindow', displayEditModal]" v-if="showEditModal">
        <div class="ModalWindow-container">
          ...
          <form class="ModalWindow-content row" @submit.prevent="updateStudent">
            <div class="input-field col s12">
              <i class="material-icons prefix">account_circle</i>
              <input v-model="activeStudent.idcliente" name="idnew" type="text" placeholder="Numero de cedula" required>
            </div>
            <div class="input-field col s12">
              <i class="material-icons prefix">email</i>
            ...
            <div class="input-field col s12">
              ...
              <input v-model="activeStudent.idcliente" name="idcliente" type="hidden" required>
            </div>
          </form>
        </div>
      </section>
